...
const Socities = () => {
  ...
  return (
    <>
      <div className='p-4 w-full border border-[#4880FF] rounded-2xl flex flex-col-reverse lg:flex-row bg-gray-900'>
        ...
        <button
          ...
          className='flex items-center gap-2 bg-gray-900 px-4 py-2 text-white hover:bg-[#4880FF] border border-white rounded-md transition-all duration-300 ease-in-out ml-auto h-10 mt-4 lg:mt-0'
        >
          <Plus />
